...
function Header(props) {
    return (
        <div className=" banner min-h-screen flex justify-center items-center flex-col">
       
          <div className="content">
            <h1 className="title-font text-3xl lg:text-5xl text-center mx-2">Supercharge Your Productivity</h1>
          </div>
          ...
          <div>
            <Link to='/register' className="btn-common hover:text-[#D5FFD0] hover:bg-[#279EFF] transition-all duration-300">Let's Explore</Link>
          </div>
